...
export const InvalidApplication = ({ jobId }) => (
  <div className='w-full h-full flex justify-center items-center flex-col gap-4'>
    ...
    <Link href={`/projects/${jobId}`}>
      <button className='font-bold inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm rounded-md text-white bg-secondary hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary'>
